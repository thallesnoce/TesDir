...
module TesouroGraficosModule {
    export class ChartTitulosVencidoController {
        public vm: ChartViewModel = new ChartViewModel();
        private chartHandler: ChartHandler;
        private titlePage: string = "Gráfico de preços e taxas dos títulos vencidos do Tesouro Direto";

        constructor(private $scope: ng.IScope, private $routeParams: IBondRouteParams) {            
            this.chartHandler = new ChartHandler('chart-container', 'Gráfico dos Títulos Vencidos do Tesouro Direto');
